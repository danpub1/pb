...
* Collage-mode: after page layout, resize & reshape to eliminate blank space
  * Watershed / Voronoi? Adhoc - incrementally resize until space is eliminated?
  * Whole page / parts of page
  * Assumed no captions on images that are involved?
  * Texts that don't resize but can be moved / Texts that can be reshaped
* Calendar pages
